...
module {
  aie.device(NPUDEVICE) {
    ...
    aie.runtime_sequence(%arg0: memref<64xi32>, %arg1: memref<32xi32>, %arg2: memref<64xi32>) {
      ...
      // Back-to-back dispatch: S2MM 0 FIRST then MM2S 0, no dma_wait between.
      // S2MM-first arms the EMU gate with dispatch_s2mm(0)=3050; tests whether
      // HW's post-S2MM-dispatch cross-channel gap is ~3050 (gate faithful) or
      // ~924 like MM2S-first (gate over-charges cross-channel = the SP-4a bug).
      aiex.npu.dma_memcpy_nd(%arg2[%c0_i64, %c0_i64, %c0_i64, %c0_i64] [%c1_i64, %c1_i64, %c1_i64, %c64_i64] [%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 0 : i64, metadata = @out, issue_token = true} : memref<64xi32>
      aiex.npu.dma_memcpy_nd(%arg0[%c0_i64, %c0_i64, %c0_i64, %c0_i64] [%c1_i64, %c1_i64, %c1_i64, %c64_i64] [%c0_i64, %c0_i64, %c0_i64, %c1_i64]) {id = 1 : i64, metadata = @in, issue_token = true} : memref<64xi32>
