...
//! port layouts, timing constants, FoT values, packet formats, and ISA
//! decoder tables -- lives under this module. The decoder FFI (Task 10)
//! lands here next.
...
///
/// The `decoder_tables` submodule contains all decodable AIE2 instructions
/// with their slot, format, encoding, and operand layout. Generated by
/// `build_helpers::codegen::generate_tablegen_file` into `$OUT_DIR/gen_tablegen.rs`.
pub mod isa;
