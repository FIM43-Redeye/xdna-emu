...
impl DmaModel for Aie2DmaModel {
    ...
    fn timing_config(&self) -> DmaTimingConfig {
        ...
        DmaTimingConfig {
            ...
            stream_words_per_cycle: timing::DMA_STREAM_WORDS_PER_CYCLE,
            ...
            memtile_first_bd_startup_cycles: timing::DMA_MEMTILE_FIRST_BD_STARTUP_CYCLES,
            compute_first_bd_startup_cycles: timing::DMA_COMPUTE_FIRST_BD_STARTUP_CYCLES,
        }
    }
}
...
mod tests {
    ...
    fn timing_config_matches_aie2_constants() {
        ...
        assert_eq!(cfg.stream_words_per_cycle, timing::DMA_STREAM_WORDS_PER_CYCLE);
