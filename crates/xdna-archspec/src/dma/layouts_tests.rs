...
mod tests {
    ...
    // ====================================================================
    // Helper: load the real AM025 register database, or skip if unavailable.
    // ====================================================================

    /// Load the real register database (skips if not available).
    ///
    /// Uses CARGO_MANIFEST_DIR (crates/xdna-archspec/) to find the JSON
    ...
    fn load_test_db() -> Option<RegisterDb> {
        ...
        RegisterDb::from_file(&json_path).ok()
    }

    // ====================================================================
    // BitField unit tests (no DB required)
    // ====================================================================
    ...
    // ====================================================================
    // Integration tests -- require real AM025 database
    // ====================================================================
