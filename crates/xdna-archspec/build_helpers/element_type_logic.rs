...
//   - crates/xdna-archspec/build_helpers/element_type_logic.rs  (this file, build-time)
//   - src/tablegen/element_type_logic.rs                        (runtime)
//
// The build-time copy lives here in archspec's build_helpers alongside the
// TableGen extraction code. The runtime copy is a regular module of the
// xdna-emu tablegen subsystem.
//
