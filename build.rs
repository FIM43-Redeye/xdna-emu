...
//! port arrays/ranges, subsystem ranges, core/lock registers) has moved to
//! `crates/xdna-archspec/build.rs`. This script handles the remaining
//! xdna-emu-specific outputs.
//!
//! Generated files (written to `$OUT_DIR/`):
//! - `gen_trace_events.rs`  -- mlir-aie trace event codes (included by `trace` module)
...
fn main() {
    ...
    // gen_stream_ports(), and gen_stream_ranges() have all moved to
    // xdna-archspec/build.rs (Tasks 4-7).
...
// ============================================================================
// Trace event codes from mlir-aie bridge
// ============================================================================
