module {
  aie.device(npu1_1col) {
    ...
    aie.runtime_sequence(%arg0: memref<64xi32>, %arg1: memref<32xi32>, %arg2: memref<64xi32>, %arg3: memref<262144xi32>) {
      ...
      aiex.npu.maskwrite32 {address = 119296 : ui32, column = 0 : i32, mask = 7936 : ui32, row = 0 : i32, value = 3840 : ui32}
      aiex.npu.write32 {address = 119300 : ui32, column = 0 : i32, row = 0 : i32, value = 2147483663 : ui32}
