//===- test.cpp -------------------------------------------------*- C++ -*-===//
//
// Host harness for the Half-B vec_srs_i32_r13_s0 capture kernel (GENERATED -- edit the spec
...
// vec_srs_i32_r13_s0 datapath ran correctly. Expected values are the genuine
