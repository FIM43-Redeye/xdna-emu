//===- test.cpp -------------------------------------------------*- C++ -*-===//
//
// Host harness for the Half-B vec_pack_i16_s1 capture kernel (GENERATED -- edit the spec
...
// vec_pack_i16_s1 datapath ran correctly. Expected values are the genuine
