//===- aie.mlir ------------------------------------------------*- MLIR -*-===//
//
// Half-B vec_srs_i32_r3_s1 capture design (GENERATED). Single compute tile (0,2) reads a
// 64-element batch from DDR via shim DMA, runs the vec_srs_i32_r3_s1 kernel, writes the
