//===- aie.mlir ------------------------------------------------*- MLIR -*-===//
//
// DENSE fp32 special-value sub sweep (GENERATED). Single compute tile
// (0,2) reads two 2032-element f32 operand matrices from DDR via shim DMA,
// runs sub_fp32, writes the 2032-element result back.
//
//===----------------------------------------------------------------------===//

module {
  aie.device(npu1_1col) {
    func.func private @sub_fp32(memref<2032xf32>, memref<2032xf32>, memref<2032xf32>)
    ...
    %core_0_2 = aie.core(%core) {
      ...
      func.call @sub_fp32(%a, %b, %o) : (memref<2032xf32>, memref<2032xf32>, memref<2032xf32>) -> ()
