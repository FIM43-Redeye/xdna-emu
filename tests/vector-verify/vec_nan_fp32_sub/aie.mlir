...
// sub_fp32 kernel, writes the 256-element f32 result back. Direct
...
module {
  aie.device(npu1_1col) {
    func.func private @sub_fp32(memref<256xf32>, memref<256xf32>, memref<256xf32>)
    ...
    %core_0_2 = aie.core(%core) {
      ...
      func.call @sub_fp32(%a, %b, %o) : (memref<256xf32>, memref<256xf32>, memref<256xf32>) -> ()
