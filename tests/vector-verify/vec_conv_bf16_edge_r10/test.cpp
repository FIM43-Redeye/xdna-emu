//===- test.cpp -------------------------------------------------*- C++ -*-===//
//
// Host harness for the Half-B vec_conv_bf16_edge_r10 capture kernel (GENERATED -- edit the spec
...
// vec_conv_bf16_edge_r10 datapath ran correctly. Expected values are the genuine
...
static const uint16_t EXP[96] = {
    ...
    32768, 32768, 32768, 32768, 32768, 32768, 32769, 32769,
