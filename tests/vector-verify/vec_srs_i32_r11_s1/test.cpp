//===- test.cpp -------------------------------------------------*- C++ -*-===//
//
// Host harness for the Half-B vec_srs_i32_r11_s1 capture kernel (GENERATED -- edit the spec
...
// vec_srs_i32_r11_s1 datapath ran correctly. Expected values are the genuine
