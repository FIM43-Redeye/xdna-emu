//===- aie.mlir ------------------------------------------------*- MLIR -*-===//
//
// Half-B vec_conv_bf16_r3 capture design (GENERATED). Single compute tile (0,2) reads a
// 448-element batch from DDR via shim DMA, runs the vec_conv_bf16_r3 kernel, writes the
