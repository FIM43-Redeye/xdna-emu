//===- aie.mlir ------------------------------------------------*- MLIR -*-===//
//
// Half-B vec_pack_i16_s0 capture design (GENERATED). Single compute tile (0,2) reads a
// 96-element batch from DDR via shim DMA, runs the vec_pack_i16_s0 kernel, writes the
