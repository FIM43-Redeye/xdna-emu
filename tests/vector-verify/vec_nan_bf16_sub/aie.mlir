...
// sub_bf16 kernel, writes the 256-element bf16 result back. Direct
...
module {
  aie.device(npu1_1col) {
    func.func private @sub_bf16(memref<256xbf16>, memref<256xbf16>, memref<256xbf16>)
    ...
    %core_0_2 = aie.core(%core) {
      ...
      func.call @sub_bf16(%a, %b, %o) : (memref<256xbf16>, memref<256xbf16>, memref<256xbf16>) -> ()
