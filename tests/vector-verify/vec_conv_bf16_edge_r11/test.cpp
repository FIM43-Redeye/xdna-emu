//===- test.cpp -------------------------------------------------*- C++ -*-===//
//
// Host harness for the Half-B vec_conv_bf16_edge_r11 capture kernel (GENERATED -- edit the spec
...
// vec_conv_bf16_edge_r11 datapath ran correctly. Expected values are the genuine
