//===- test.cpp -------------------------------------------------*- C++ -*-===//
//
// Host harness for the Half-B vec_ups_i32_s0 capture kernel (GENERATED -- edit the spec
...
// vec_ups_i32_s0 datapath ran correctly. Expected values are the genuine
