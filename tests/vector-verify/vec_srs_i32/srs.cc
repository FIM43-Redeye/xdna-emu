...
// vector_kernel_specs.py, not this file). SRS (shift-round-saturate), int32 accumulator -> int16. Config: rnd=FLOOR, sat=saturate, sym_sat=false, shift=4 -- the matching slice of the Half-A `srs` golden.
//
//===----------------------------------------------------------------------===//
