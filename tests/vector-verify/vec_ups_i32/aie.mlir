//===- aie.mlir ------------------------------------------------*- MLIR -*-===//
//
// Half-B vec_ups_i32 capture design (GENERATED). Single compute tile (0,2) reads a
// 48-element batch from DDR via shim DMA, runs the vec_ups_i32 kernel, writes the
