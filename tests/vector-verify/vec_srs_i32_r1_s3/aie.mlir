//===- aie.mlir ------------------------------------------------*- MLIR -*-===//
//
// Half-B vec_srs_i32_r1_s3 capture design (GENERATED). Single compute tile (0,2) reads a
// 64-element batch from DDR via shim DMA, runs the vec_srs_i32_r1_s3 kernel, writes the
