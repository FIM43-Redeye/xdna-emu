...
| **Host / firmware dispatch** | [`fidelity-gaps/host-firmware-dispatch.md`](fidelity-gaps/host-firmware-dispatch.md) | off-array / firmware seam | dispatch latency (deferred), core reset-deassert (**root-caused**, Part 1 landed `1e9e6700`), firmware-selected device-heap translation, `CONFIG_CU` / PDI handoff, and first dual-compiler unmodified-driver round trip through chained and direct execution envelopes (**fixed**) |
