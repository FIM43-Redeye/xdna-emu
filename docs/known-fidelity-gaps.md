...
| **Firmware MMU** | [`fidelity-gaps/firmware-mmu.md`](fidelity-gaps/firmware-mmu.md) | needs-HW-empirical | double-exception DEPC/RFDE (**fixed**), EXCVADDR on autorefill (unobservable), varway56 ways 5/6 (coherence-inferred, non-blocking) |
