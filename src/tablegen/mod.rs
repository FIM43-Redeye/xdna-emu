...
// Canonical runtime copy lives here; the build-time copy lives in
// crates/xdna-archspec/build_helpers/element_type_logic.rs. Both must
// stay in sync -- see the file header for details.
