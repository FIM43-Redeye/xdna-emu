...
/// tile dimensions and accumulator mode.
///
/// These entries are derived from the hardware's permute mode table. Each
/// entry corresponds to one or more pmode indices that the instruction can
/// select.
...
const DENSE_GEOMETRY_TABLE: &[GeometryEntry] = &[
...
const SPARSE_GEOMETRY_TABLE: &[GeometryEntry] = &[
