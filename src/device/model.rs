...
//! `aie-device-models.json` file against the compile-time `crate::arch::*`
...
//! `build.rs`) to produce the compile-time constants in `crate::arch`. This
...
/// matches the compile-time `crate::arch::*` constants.
///
