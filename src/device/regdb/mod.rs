...
// Re-export base types from the archspec crate. All consumers of
// `crate::device::regdb::BitField` etc. continue to work unchanged.
pub use xdna_archspec::regdb::*;

// Re-export all field layout types so callers see no change.
...
// ============================================================================
// DeviceRegLayout: aggregated register layouts for one device architecture
// ============================================================================
